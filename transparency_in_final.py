...
# rules = {
#     "Drama": " We recommend these movies because we think you are happy and might enjoy watching thought-provoking and emotional stories that may resonate with you on a deeper level.",
#     "War": "We recommend these movies because we think your mood is low and sometimes watching a thrilling and action-packed movie can provide an escape from reality and help shift the focus from the source of sadness, even if only temporarily.",
#     "Comedy": "We recommend these movies because comedy movies are a great choice to watch when you're feeling surprised because they can help you laugh and relieve any tension or shock you may be feeling. Laughter has been shown to release endorphins, which can boost your mood and help you feel more relaxed.",
#     "Action": "We recommend these movies because we think you are a little afraid right now and action movies can be a good choice to watch when you're feeling scared because they can help distract you from your fears and provide a sense of excitement and adrenaline. Watching intense fight scenes and daring stunts can also help you feel empowered and courageous."   
# }
...
if mood == "joy":
    ...
    st.write("We recommend these movies because we think you are happy and might enjoy watching thought-provoking and emotional stories that may resonate with you on a deeper level.")
    feedback()
    ...
    with col5:
        st.text(romantic_movies[4])
        st.image(romantic_movies_posters[4], width=135)
    st.write("We recommend these movies because we think your mood is low and sometimes watching a thrilling and action-packed movie can provide an escape from reality and help shift the focus from the source of sadness, even if only temporarily.")
    feedback()
    ...
    with col5:
        st.text(romantic_movies[4])
        st.image(romantic_movies_posters[4], width=135)
    st.write("We recommend these movies because comedy movies are a great choice to watch when you're feeling surprised because they can help you laugh and relieve any tension or shock you may be feeling. Laughter has been shown to release endorphins, which can boost your mood and help you feel more relaxed.")
    feedback()
    ...
    with col5:
        st.text(romantic_movies[4])
        st.image(romantic_movies_posters[4], width=135)
    st.write("We recommend these movies because we think you are a little afraid right now and action movies can be a good choice to watch when you're feeling scared because they can help distract you from your fears and provide a sense of excitement and adrenaline. Watching intense fight scenes and daring stunts can also help you feel empowered and courageous.")
    feedback()
